...
export function ThemeTab({
  ...
  const handleRandomCodexa = () => {
    // Apply a random codexa theme
  ...
  const handleRandomTweakcn = () => {
    ...
    setSelectedTheme("") // Clear codexa selection
    setBrandColorsValues({}) // Clear brand colors state
    setImportedTheme(null) // Clear imported theme
  ...
  return (
    <div className="p-4 space-y-6">
      ...
      {/* Codexa UI Theme Presets */}
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <Label className="text-sm font-medium">Codexa UI Theme Presets</Label>
          <Button variant="outline" size="sm" onClick={handleRandomCodexa} className="cursor-pointer">
        ...
        <Select value={selectedTheme} onValueChange={(value) => {
          ...
          <SelectTrigger className="w-full cursor-pointer">
            <SelectValue placeholder="Choose Codexa Theme" />
          </SelectTrigger>
