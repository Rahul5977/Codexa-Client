    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background/80 backdrop-blur-xl supports-backdrop-filter:bg-background/60">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex h-16 items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          <a href="https://codexastore.com" className="flex items-center space-x-2 cursor-pointer" target='_blank' rel="noopener noreferrer">
            <Logo size={32} />
        ...
        <div className="hidden xl:flex items-center space-x-2">
          ...
          <Button variant="ghost" size="icon" asChild className="cursor-pointer">
            <a href="https://github.com/silicondeck/codexa-dashboard-landing-template" target="_blank" rel="noopener noreferrer" aria-label="GitHub Repository">
            ...
            <div className="flex flex-col h-full">
              ...
              <SheetHeader className="space-y-0 p-4 pb-2 border-b">
                <div className="flex items-center gap-2">
                  ...
                  <SheetTitle className="text-lg font-semibold">Codexa</SheetTitle>
